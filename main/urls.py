...
urlpatterns = [
    ...
    path("password-reset/", auth_views.PasswordResetView.as_view(
        template_name="main/resetPassword.html"), name="password_reset"),
    path("password-reset/done/", auth_views.PasswordResetDoneView.as_view(
        template_name="main/resetPasswordDone.html"), name="password_reset_done"),
    path("password-reset-confirm/<uidb64>/<token>/", auth_views.PasswordResetConfirmView.as_view(
        template_name="main/confirmResetPassword.html"), name="password_reset_confirm"),
    path('password-reset-complete/', auth_views.PasswordResetCompleteView.as_view(
        template_name='main/resetPasswordComplete.html'), name="password_reset_complete"),
